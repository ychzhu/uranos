...
1. Download the zipped binary package and the ENDF data zip file. The binaries can be found in this repository in the /binaries folder and the ENDF data can be found in the /data folder.
